...
contract AddressBook {
    ...
    function getAddressArray(address addr) view  public returns (address[] memory) {
    ...
    function getAlias(address addrowner, address addr) view  public returns (string memory) {
